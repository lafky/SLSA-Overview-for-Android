...
class SimpleEcho(WebSocket):
	...
	sh6 = PV('PP00SR10FE02PSH01:CLOSED_STATUS')
	...
	def handleMessage(self):
		...
		if str(self.data) == "everything":
			...
			self.warn1 = ""
			self.warn2 = ""
			if int(self.linSSum) != 0 or int(self.linHSum) != 0 or int(self.linVSum) != 0 or int(self.linQSum) != 0 or int(self.ltbDSum) != 3 or int(self.ltbHSum) != 2 or int(self.ltbVSum) != 4 or int(self.ltbQSum) != 11 or float(self.k1V) < 35 or float(self.k2V) < 34 or float(self.gV) < 89:
				self.warn1 = "bad1"
